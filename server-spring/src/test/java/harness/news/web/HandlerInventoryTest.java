...
class HandlerInventoryTest {
	...
	/**
	 * phase 68이 소유한 7 라우트 — {@code server-spring/README.md}·index.json forward_notes (2)와 같은 목록이다.
	 * 표기는 Spring 매핑 원문({@code {userId}})이다.
	 */
	 ...
	 * 조용히 무시하면 "핸들러는 7개뿐"이라는 문장이 사실과 어긋난 채로 남는다.
	 */
