...
export function parseVerifyReport(text) {
  ...
  for (const raw of lines) {
    ...
    if (totals) { sourceRows = Number(totals[2]); targetRows = Number(totals[3]); continue; }
  ...
  return {
    verdict, matched: verdict === '일치', sourceRows, targetRows, excluded, tables, structural, diffs,
  };
}
